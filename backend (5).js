    ...
    const requestBody = {
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are an expert image forensics analyst specializing in AI-generated content detection. Carefully examine this image and determine whether it is a REAL photograph or AI-GENERATED.

Analyze these key indicators systematically:

1. HANDS AND FINGERS — Count fingers carefully. Extra/missing/melted fingers are STRONG AI indicators. Normal motion blur is acceptable.

2. FACES — Check facial symmetry, eye alignment, teeth consistency. Distorted or anatomically impossible features indicate AI. Poor camera quality alone is NOT an AI sign.

3. TEXT — Any text must be readable and make sense. Garbled, nonsensical, or impossible text is a STRONG AI indicator.

4. OBJECTS AND EDGES — Objects should have natural, distinct boundaries. Melting/blending between separate objects suggests AI generation.

5. BACKGROUNDS — Verify lighting consistency, perspective accuracy, and logical composition.

6. SKIN TEXTURE — AI often creates unnaturally smooth, plastic-like skin with no visible pores. Natural skin has texture even in good photos.

7. ANATOMY — Verify correct number of limbs, proper body proportions, logical object structure.

8. ARTIFACTS — Look for AI telltales: impossible geometry, dream-like distortions, inconsistent detail levels, unnatural patterns.

CRITICAL: Blurry or low-resolution photos are NOT automatically AI-generated. Many real photos are blurry due to motion, poor lighting, or old cameras. Focus on IMPOSSIBLE or UNNATURAL features, not image quality.

CONFIDENCE SCORING GUIDE:
- 90-100%: Multiple clear, undeniable AI artifacts (extra fingers, garbled text, melted objects)
- 75-89%: Strong evidence of AI (2-3 clear indicators)
- 60-74%: Moderate evidence (1-2 subtle indicators)  
- 40-59%: Unclear/could go either way
- 25-39%: Probably real but some unusual features
- 0-24%: Clearly a real photograph
...
- confidence: Use the guide above. Be decisive - if you see clear AI artifacts, use 85-95%. If clearly real, use 85-95%.
- observations: Must be SPECIFIC to THIS image. No generic statements. Describe exactly what you see.`
          }
        ]
      }]
    };
