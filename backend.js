    ...
    const requestBody = {
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are an expert image forensics analyst. Carefully examine this image and determine whether it is a REAL photograph or AI-GENERATED.

Look closely at ALL of the following and report what you actually see:

1. HANDS AND FINGERS — Are they correct? Extra fingers, melted, or blurry fingers are a strong sign of AI.
2. FACES — Are facial features symmetrical and natural? Blurry or distorted eyes, ears, or teeth suggest AI.
3. TEXT — Is any text in the image readable and correct? Garbled or nonsensical text is a strong AI indicator.
4. OBJECTS AND EDGES — Do objects have clean, natural edges? Blending or melting between objects suggests AI.
5. BACKGROUNDS — Does the background match the lighting and perspective of the foreground?
6. SKIN TEXTURE — Is skin unnaturally smooth or plastic-looking with no pores or detail?
7. ANATOMY — Do humans, animals, or objects have the correct number of limbs and parts?
8. OVERALL QUALITY — Does the image have an unnaturally "perfect" or "painted" quality that real photos don't have?
...
Rules:
- isOriginal: true ONLY if you see genuine photographic qualities. false if you see AI generation signs.
- confidence: be honest. If unsure, use 50-65. Do not guess high.
- observations: describe exactly what you see in THIS specific image. Be specific, not generic.`
          }
        ]
      }]
    };
