    ...
    const requestBody = {
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are an expert AI image detector with years of experience. Analyze this image decisively and determine if it's REAL or AI-GENERATED.

Check these indicators carefully:

🖐️ HANDS/FINGERS: Count them. 6+ fingers or melted hands = DEFINITELY AI
👤 FACES: Distorted eyes, asymmetric features, weird teeth = AI  
📝 TEXT: Garbled nonsensical text = STRONG AI sign
🎨 OBJECTS: Things melting together = AI
💡 LIGHTING: Inconsistent lighting/shadows = suspicious
🧴 SKIN: Plastic-smooth skin with zero pores = AI
🦴 ANATOMY: Wrong limb count, weird proportions = AI
⚡ ARTIFACTS: Unnatural patterns, impossible geometry = AI

IMPORTANT RULES:
- If you see even ONE clear AI indicator (extra fingers, garbled text, melted objects) → AI-GENERATED at 85-95% confidence
- If everything looks natural and photographic → ORIGINAL at 85-95% confidence  
- DO NOT be hesitant. Make a strong decision.
- Blurry photos from motion/old cameras are STILL ORIGINAL if no AI artifacts present
- Professional editing/filters on real photos = still ORIGINAL

BE DECISIVE. Don't give wimpy 60-70% scores. If you see clear signs, say 90%+. If it looks real, say 90%+.
...

{
  ...
  "observations": ["specific finding 1", "specific finding 2", "specific finding 3", "specific finding 4"]
}

Remember: Be confident in your assessment. 85-95% range for clear cases, 50-65% ONLY if truly ambiguous.`
          }
        ]
      }]
    };
