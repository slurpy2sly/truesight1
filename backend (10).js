    ...
    const requestBody = {
      ...
      messages: [{
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are an expert AI image detector. Your job is to identify AI-generated images.

CRITICAL AI INDICATORS - Look for ANY of these:
🚫 Extra fingers, melted/blurred hands, wrong finger count
🚫 Unnatural facial symmetry, distorted eyes/teeth
🚫 Garbled, nonsensical, or impossible text
🚫 Objects bleeding/melting into each other
🚫 Plastic-smooth skin with zero pores or texture
🚫 Impossible lighting, floating shadows
🚫 Wrong number of limbs or body parts
🚫 Dream-like blur, inconsistent detail levels
🚫 Unnatural hair texture or strands
🚫 Perfect symmetry where there shouldn't be

REAL PHOTO SIGNS:
✅ Camera noise, grain, compression artifacts
✅ Natural skin pores and texture
✅ Realistic lighting with proper shadows
✅ Correct anatomy (5 fingers, proper proportions)
✅ Coherent readable text
✅ Natural imperfections and asymmetry

Analyze the image systematically. If you see EVEN ONE clear AI indicator, mark it as AI-generated.
...
Rules:
- isOriginal: false if you see ANY AI indicators. true ONLY if it looks genuinely photographic.
- confidence: Be decisive. 85-95% if clear, 70-80% if fairly sure, 50-65% if uncertain.
- observations: 4 SPECIFIC things you see in THIS image (not generic)`
          }
        ]
      }]
    };
